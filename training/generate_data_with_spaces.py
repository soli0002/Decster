...
# Generate synthetic data with random dictionary words
def generate_synthetic_data_with_dictionary_words(filename, num_samples_per_type=1000):
    with open(filename, 'w', newline='') as csvfile:
        csv_writer = csv.writer(csvfile)
        csv_writer.writerow(['Encoded Text', 'Encoding Type'])
...
if __name__ == "__main__":
    synthetic_data = generate_synthetic_data_with_dictionary_words("training_data.csv", num_samples_per_type=50000)
